...
public class JwtService {
    ...
    // A chave secreta deve ser mantida em segredo e não deve ser exposta no código. Este é apenas um exemplo.
    private static final Key SECRET_KEY = Keys.secretKeyFor(SignatureAlgorithm.HS256);
    private static final long EXPIRATION_TIME = 3600;
    private static final long REFRESH_EXPIRATION_TIME = 3600 * 2 ;
