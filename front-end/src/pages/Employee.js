  ...
  const payPopupContent = (
    <div className="popup">
      <div className="popup-inner fade-in">
        ...
        <div className="flex justify-center mt-5">
          <button onClick={() => setIsPayPopupOpen(false)} className="popup-button popup-button-cancel">Cancel</button>
          <button onClick={handlePayment} className="popup-button popup-button-confirm">Confirm Payment</button>
   
          {/* <button onClick={() => {  setIsPayPopupOpen(false); }} className="popup-button popup-button-confirm">Confirm Payment</button> */}
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="employee-container">
      <div className="employee-header">
        <h2 className="employee-title">Employee Page</h2>
      </div>
